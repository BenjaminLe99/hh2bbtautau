...
def add_variables(config: od.Config) -> None:
    ...
    for proc in ["hh", "tt", "dy"]:
        ...
        weight_matrix_models_list = [
            ...
            "new_implementation",
            "test_regressed_nu",
            "bg_bgmiss_bgcross_with_nu",
            "bg_bgmiss_bgcross_nosig_with_nu",
            "bg_bgmiss_bgcross_with_nu_kl1",
            "bg_bgmiss_bgcross_with_nu_kl2p45",
            "bg_bgmiss_bgcross_with_nu_kl5",
            "bg_bgmiss_bgcross_with_nu_kl0",
            "bg_bgmiss_bgcross_with_nu_kl0_lr_adjust",
            "ce_with_nu_kl1",
            "ce_with_nu_kl1_v2",
            "ce_with_nu_kl1_v3",
            "ce_with_nu_kl1_v4",
            ...
            "ce_with_nu_kl0",
            "ce_diag1111_kl0_kl1",
            "ce_diag1111_kl0_kl1_uneven_importance",
            "wm_all1s_kl0_kl1",
            "wm_diag11p5p5_kl0_kl1",
            "wm_diag11p5p5_kl0_kl1_uneven_importance",
            "ce_diag1111_kl0_kl1_fixed_v2",
            "ce_diag111_kl1_fixed_v1",
            "ce_diag1111_kl0_kl1_uneven",
            "diag1155_kl0_kl1",
            "diag11p5p5_kl0_kl1",
